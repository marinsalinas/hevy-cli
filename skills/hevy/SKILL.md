...
| `Error: Workout '<id>' not found` or `Error: Workouts not found` | ID or collection does not exist | Confirm the ID; for routines, try search-by-name with `hevy routines rename` |
